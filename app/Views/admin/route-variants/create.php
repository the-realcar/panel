...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="/admin/route-variants/create.php">
            <?php echo csrfField(); ?>
            ...
            <div class="form-group">
                ...
                <select id="line_id" name="line_id" class="form-control" required>
                    ...
                    <?php foreach ($lines as $line): ?>
                        <option value="<?php echo (int)$line['id']; ?>" <?php echo (isset($form_data['line_id']) && (int)$form_data['line_id'] === (int)$line['id']) ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" id="direction" name="direction" class="form-control" value="<?php echo e($form_data['direction'] ?? ''); ?>" placeholder="np. Dworzec -> Osiedle">
            </div>

            <div class="form-group">
                <label class="checkbox-label">
                    <input type="checkbox" name="is_active" <?php echo isset($form_data['is_active']) ? 'checked' : ''; ?>>
                    Aktywny wariant
                </label>
            </div>
